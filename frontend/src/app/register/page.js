    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-white p-4">
      <div className="text-center mb-6">
        <div className="flex justify-center items-center gap-2">
          <img src="/assets/clover.png" alt="Clover" className="w-8 h-8" />
          <h1 className="text-4xl font-bold text-gray-800">Saponé</h1>
          <img src="/assets/clover.png" alt="Clover" className="w-8 h-8" />
        </div>
      </div>
      ...
      <div className="w-full max-w-md border p-8 rounded shadow-sm">
        ...
        <div className="mb-4">
          ...
          <input type="username" className="w-full px-4 py-2 bg-gray-100 rounded" />
        </div>
